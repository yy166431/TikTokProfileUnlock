...
TikTok profile/self API 抓包 dylib，直接 hook NSJSONSerialization + TTHttpResponseChromium 获取完整请求和响应。
...
1. 下载最新 release 的 `TikTokCapture.dylib`
2. 用 TrollStore 注入到 TikTok
...
- `GET http://localhost:9999/` - Web 界面
